...
import { Shield, Bell, Radio, LogOut, User, Menu } from "lucide-react";

export default function Navbar({ activePage, setActivePage, user, onLogout, onToggleMobileMenu, liveCount = 30, alertCount = 3 }) {
  return (
    <header className="sticky top-0 z-30 h-16 border-b border-[#1e2a3a] bg-[#111823]/95 backdrop-blur px-4 sm:px-6 flex items-center justify-between">
      <div className="flex items-center gap-3">
        ...
        <div className="h-9 w-9 rounded-lg bg-blue-600/20 border border-blue-500/40 flex items-center justify-center text-blue-400 shrink-0">
        ...
        <div>
          ...
          <p className="text-[10px] text-[#7d8da3] uppercase tracking-wider hidden sm:block">Gujarat Police Command Grid</p>
        </div>
      </div>
