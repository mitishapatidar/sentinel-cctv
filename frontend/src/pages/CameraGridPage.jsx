  ...
  return (
    <div className="flex-1 flex flex-col overflow-y-auto">
      ...
      <div className="border-b border-[#1e2a3a] px-6 py-4 bg-[#111823] flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <select
            ...
            className="bg-[#0a0e14] border border-[#1e2a3a] rounded-xl px-3 py-1.5 text-xs text-white focus:outline-none focus:border-blue-500"
          >
      ...
      <div className="p-6 flex-1">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 text-[#7d8da3] text-xs gap-2">
            <RefreshCw className="h-6 w-6 animate-spin text-blue-400" />
            <span>Connecting to Unified Feed Gateway...</span>
          </div>
              ...
              >
                ...
                <div className="relative aspect-video w-full bg-black">
                  ...
                  <button
                    ...
                    className="absolute bottom-2 right-2 p-1.5 rounded-lg bg-black/60 text-white/80 hover:text-white hover:bg-black/90 backdrop-blur transition-all cursor-pointer opacity-0 group-hover:opacity-100"
